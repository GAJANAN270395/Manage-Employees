  ...
  return(
    <div className='clearfix'>
      <div className='hint-text'>
        Showing <b>{currentEmployees.length}</b>
        out of <b> {totalEmployee} </b> entries
      </div>
      <ul className='pagination'>
        ...
        <li
          className={
            currentButton === numOfPage.length ? "page-item disabled" : "page-item"
          }
        >
          <a
            href='#!'
            className={
              currentButton === numOfPage.length ? "page-link disabled" : "page-link"
            }
            onClick={() =>
